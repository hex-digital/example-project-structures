...
Notification objects are of the type NotificationData, imported from '~/app/features/Notifications/types.ts'

### On-the-fly

```vue
<script setup lang="ts">
import { DISMISS, useUiNotification } from '~/app/features/Notifications'
import type { NotificationData } from '~/app/features/Notifications'
...
<script setup lang="ts">
import { DISMISS, useUiNotification } from '~/app/features/Notifications'
import loginNotification from '~/domain/authentication/notifications/loginNotification'
...
The default time-to-live for all notifications is set in `~/app/ui/base/Notifications/config.ts`. Each individual
...
```typescript
import { DISMISS } from '~/app/features/Notifications'
